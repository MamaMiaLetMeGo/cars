...
class TransmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transmission" do
    assert_difference('Transmission.count') do
      post transmissions_url, params: { transmission: { transmission: @transmission.transmission } }
    end
  ...
  test "should update transmission" do
    patch transmission_url(@transmission), params: { transmission: { transmission: @transmission.transmission } }
